...
class Ui_dialogInput(object):
    def setupUi(self, dialogInput):
        ...
        dialogInput.setLocale(QtCore.QLocale(QtCore.QLocale.Language.English, QtCore.QLocale.Country.UnitedStates))
        self.gridLayout = QtWidgets.QGridLayout(dialogInput)
        self.gridLayout.setObjectName("gridLayout")
        self.labelDescription = QtWidgets.QLabel(parent=dialogInput)
        ...
        self.lineEdit = QtWidgets.QLineEdit(parent=dialogInput)
        self.lineEdit.setEchoMode(QtWidgets.QLineEdit.EchoMode.Normal)
        self.lineEdit.setObjectName("lineEdit")
        self.horizontalLayout.addWidget(self.lineEdit)
        self.gridLayout.addLayout(self.horizontalLayout, 1, 0, 1, 1)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=dialogInput)
    ...
    def retranslateUi(self, dialogInput):
        ...
        dialogInput.setWindowTitle(_translate("dialogInput", "Title"))
        self.labelDescription.setText(_translate("dialogInput", "Description."))
